...
public interface EssayMapper {
    ...
    @Insert("INSERT INTO essay(title, content, submitDate) VALUES(#{title}, #{content}, #{submitDate})")
    ...
    @Update("UPDATE essay SET title = #{title}, content = #{content}, submitDate = #{submitDate} WHERE id = #{id}")

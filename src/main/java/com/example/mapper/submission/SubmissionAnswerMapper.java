...
public interface SubmissionAnswerMapper {
    ...
    @Insert("INSERT INTO submission_answer(submissionId, questionId, sequence, answerContent, questionScore, score) VALUES(#{submissionId}, #{questionId}, #{sequence}, #{answerContent}, #{questionScore}, #{score})")
    ...
    @Update("UPDATE submission_answer SET submissionId = #{submissionId}, questionId = #{questionId}, sequence = #{sequence}, answerContent = #{answerContent}, questionScore = #{questionScore}, score = #{score} WHERE id = #{id}")
